...
described in
[internals.md](internals.md#docker-daemon-hybrid-streaming).
...
[internals.md](internals.md#layer-compression).
...
tabulated in
[internals.md](internals.md#out-of-order-layer-delivery).
...
[internals.md](internals.md#filtering-registry-proxy).
