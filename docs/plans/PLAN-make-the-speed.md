...
| Phase | Plan | Status |
|-------|------|--------|
| 1. Replace requests with httpx | PLAN-make-the-speed-phase-01-httpx.md | Not started |
| 2. Parallel Quay API resolution | PLAN-make-the-speed-phase-02-parallel-resolution.md | Not started |
